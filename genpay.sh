...
read host
echo ""
echo "CONNECT http://$host/ HTTP/1.1[crlf]Host: $host[crlf]X-Online-Host: $host[crlf]X-Forward-Host: $host[crlf]Connection: Keep-Alive[crlf]User-Agent: Yes[crlf] CONNECT [host_port] HTTP/1.1[crlf][crlf]"
echo ""
echo "GET http://$host HTTP/1.1[crlf]Host: $host[crlf]Connection: keep-alive[crlf]Proxy-Connection: keep-alive[crlf][crlf]"
echo ""
